...
export const shadowStyles = (theme) => css`
	${theme.isDark
		? css`
				box-shadow: 0px 13px 31px rgba(103, 107, 116, 0.04),
					0px 9.45547px 20.8947px rgba(103, 107, 116, 0.032375),
					0px 6.58125px 13.5141px rgba(103, 107, 116, 0.027),
					0px 4.31641px 8.38574px rgba(103, 107, 116, 0.023125),
					0px 2.6px 5.0375px rgba(103, 107, 116, 0.02),
					0px 1.37109px 2.99707px rgba(103, 107, 116, 0.016875),
					0px 0.56875px 1.79219px rgba(103, 107, 116, 0.013),
					inset 0px 2px 1px ${theme.colors.light};
		  `
		: css`
...
export const shadowHoverStyles = (theme) => css`
	${theme.isDark
		? css`
				box-shadow: 0px 0px 31px rgba(103, 107, 116, 0.04),
					0px 0px 20.8947px rgba(103, 107, 116, 0.032375),
					0px 0px 13.5141px rgba(103, 107, 116, 0.027),
					0px 4.31641px 8.38574px rgba(103, 107, 116, 0.023125),
					0px 2.6px 5.0375px rgba(103, 107, 116, 0.02),
					0px 1.37109px 2.99707px rgba(103, 107, 116, 0.016875),
					0px 0.56875px 1.79219px rgba(103, 107, 116, 0.013),
