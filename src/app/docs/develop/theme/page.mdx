...
export const metadata = {
	title: "Theme - Develop - Cherry Design System",
	openGraph: {
		title: "Theme - Develop - Cherry Design System",
		images: OG_IMAGE,
	},
...
Alternatively you can pass the theme object directly to any Cherry component through the **theme** prop.

```tsx
import React from "react"
import { theme } from "cherry-styled-components";
