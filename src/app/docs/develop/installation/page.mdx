...
Always make sure to wrap your application in the <code>CherryThemeProvider</code> component. Ensure that your theme prop is passed down correctly. Here’s an example of how to do this:
...
1. Open your <code>layout.tsx</code> file.
