...
-   **StyledComponentsRegistry**: Creates a global registry component to collect and render all CSS in your Next.js app.
-   **CherryThemeProvider**: Wrap your app with the Cherry Theme context.

<Box title="Installation" text="Get started with development." href="/docs/develop/installation" />