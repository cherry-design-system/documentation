...
export const metadata = {
  title: "Site Images - Design - Cherry Design System",
  openGraph: {
    title: "Site Images - Design - Cherry Design System",
    images: OG_IMAGE,
  },
...
4. **Social Image**
    - This is the open graph image that serves as a preview when your website is shared on social media platforms (like Facebook, Threads, or LinkedIn).
    - Size: Varies, but a common recommendation is around 1280x670.
    - Make sure the image represents your site well and encourages users to click through.
