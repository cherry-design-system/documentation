	...
	return (
		<StyledBringOnTop>
			<Container $textAlign="center">
				...
				<Space $size={40} />
				<StyledParagraph>
					The page you are looking for is currently exploring a black
					hole. While we wait for it to return, why not enjoy some
					cosmic tunes or explore our docs like a star chart?
				</StyledParagraph>
				<Space $size={40} />
