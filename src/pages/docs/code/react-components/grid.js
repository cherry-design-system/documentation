		...
		<Page title="Grid Component">
			...
			<TableOverflow>
				<table>
					...
					<tr>
						<td>xs</td>
						<td>Defines the columns layout for SM media query</td>
						<td>Number | "auto"</td>
					</tr>
					<tr>
						<td>sm</td>
					...
					<tr>
						<td>md</td>
						<td>Defines the columns layout for MD media query</td>
						<td>Number | "auto"</td>
					</tr>
					<tr>
						<td>lg</td>
						<td>Defines the columns layout for LG media query</td>
						<td>Number | "auto"</td>
					</tr>
					<tr>
						<td>xl</td>
						<td>Defines the columns layout for XL media query</td>
						<td>Number | "auto"</td>
					</tr>
					<tr>
						<td>xxl</td>
						<td>Defines the columns layout for XXL media query</td>
						<td>Number | "auto"</td>
					</tr>
					<tr>
						<td>xxxl</td>
						<td>Defines the columns layout for XXXL media query</td>
						<td>Number | "auto"</td>
					</tr>
					<tr>
						<td>firstXs</td>
