...
To add a keyboard shortcut, set the `$shortcut` prop. While the toggle is mounted, **Cmd/Ctrl+Shift+L** flips the theme, using the same `toggleTheme` and persistence as a click:
