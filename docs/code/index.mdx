...
- **Accordion** - Show and hide content behind a clickable, animated title.
- **AvatarDropzone** - Circular single-file dropzone for profile pictures.
...
- **Dropzone** - File input drop target with drag & drop, validation, and previews.
...
- **Icon** - Render any Lucide icon by name.
...
- **Modal** - Animated dialog with Escape and outside-click dismissal.
- **Password** - Password input with a built-in show/hide reveal toggle.
- **Range** - Sliders for numeric input.
- **Select** - Dropdown menus for options.
- **Space** - Responsive vertical or horizontal spacing between elements.
- **Textarea** - Multiline text input for longer messages.
- **ThemeToggle** - Pill-shaped sun/moon switch for light and dark mode.
- **Toast** - Transient notifications with semantic colors and auto-hide.
- **Toggle** - Simplify binary choices.

## Cherry Helpers

- **Global Styles** - Consistency across your app. Define global rules here.
- **Hooks** - Utility hooks like `useOnClickOutside` for dismissing floating UI.
