...
<CodeTabs tabs={[{ label: "npm", code: "npm install cherry-styled-components" }, { label: "pnpm", code: "pnpm add cherry-styled-components" }, { label: "yarn", code: "yarn add cherry-styled-components" }]} />
